...
var periods__$1 = cljs.core.vec((function (){var G__59607 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59606_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__59606_SHARP_,(0),(3));
}),G__59607);
} else {
return G__59607;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__59613){
var vec__59614 = p__59613;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59614,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59614,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__59617 = pattern;
switch (G__59617) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59617)].join('')));
...
return p1__59618_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__59619_SHARP_){
return p1__59619_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__59620_SHARP_){
return p1__59620_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__59621_SHARP_){
return p1__59621_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__59622_SHARP_){
return p1__59622_SHARP_.getHours();
});

break;
case "day":
return (function (p1__59623_SHARP_){
return p1__59623_SHARP_.getDate();
});

break;
case "month":
return (function (p1__59624_SHARP_){
return p1__59624_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__59625_SHARP_){
return p1__59625_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59626__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__59627){
...
var key = first__59630;
var args = seq__59629__$1;
var G__59631 = key;
...
break;
case "ordinal-suffix":
var vec__59632 = (function (){var G__59635 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__59635) : syntax_list.call(null,G__59635));
})();
...
var d = value;
var G__59639 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
...
var unparser = first__59642;
var more = seq__59641__$1;
var s = "";
var d__$1 = d;
...
while(true){
var d__$2 = d__$1;
var vec__59649 = G__59639__$1;
var seq__59650 = cljs.core.seq(vec__59649);
var first__59651 = cljs.core.first(seq__59650);
var seq__59650__$1 = cljs.core.next(seq__59650);
var unparser__$1 = first__59651;
var more__$1 = seq__59650__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__59652 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59652,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59652,(1),null);
var G__59682 = d__$3;
var G__59683 = more__$1;
var G__59684 = s__$3;
d__$1 = G__59682;
G__59639__$1 = G__59683;
s__$1 = G__59684;
continue;
}
break;
