...
return [(function (){var pred__56770 = cljs.core.instance_QMARK_;
var expr__56771 = reactive_val;
if(cljs.core.truth_((pred__56770.cljs$core$IFn$_invoke$arity$2 ? pred__56770.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__56771) : pred__56770.call(null,reagent.ratom.RAtom,expr__56771)))){
return "ra";
} else {
if(cljs.core.truth_((pred__56770.cljs$core$IFn$_invoke$arity$2 ? pred__56770.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__56771) : pred__56770.call(null,reagent.ratom.RCursor,expr__56771)))){
return "rc";
} else {
if(cljs.core.truth_((pred__56770.cljs$core$IFn$_invoke$arity$2 ? pred__56770.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__56771) : pred__56770.call(null,reagent.ratom.Reaction,expr__56771)))){
return "rx";
} else {
if(cljs.core.truth_((pred__56770.cljs$core$IFn$_invoke$arity$2 ? pred__56770.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__56771) : pred__56770.call(null,reagent.ratom.Track,expr__56771)))){
return "tr";
} else {
return "other";
}
