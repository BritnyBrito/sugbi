...
var G__68276 = request;
var G__68277 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__68276,G__68277) : ajax.formats.get_format.call(null,G__68276,G__68277));
} else {
...
return cljs.core.some((function (p1__68296_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__68296_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__68308){
var map__68309 = p__68308;
var map__68309__$1 = cljs.core.__destructure_map(map__68309);
var request = map__68309__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68309__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__68329 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__68329.cljs$core$IFn$_invoke$arity$1 ? fexpr__68329.cljs$core$IFn$_invoke$arity$1(response) : fexpr__68329.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__68340){
var map__68345 = p__68340;
var map__68345__$1 = cljs.core.__destructure_map(map__68345);
var request = map__68345__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68345__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__68336_SHARP_){
return ajax.formats.get_accept_entries(request,p1__68336_SHARP_);
