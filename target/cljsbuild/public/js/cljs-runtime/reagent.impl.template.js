...
var G__56653 = o;
reagent.impl.template.goog$module$goog$object.set(G__56653,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__56654 = o;
reagent.impl.template.goog$module$goog$object.set(G__56654,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__56677__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__56677 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__56677__delegate.call(this,args);};
G__56677.cljs$lang$maxFixedArity = 0;
G__56677.cljs$lang$applyTo = (function (arglist__56680){
var args = cljs.core.seq(arglist__56680);
return G__56677__delegate(args);
});
G__56677.cljs$core$IFn$_invoke$arity$variadic = G__56677__delegate;
return G__56677;
})()
;
} else {
...
var G__56655 = props;
var G__56655__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56655,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__56655);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56655__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__56656 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56656,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__56656;
}
})(),id_class);
...
var G__56657 = (cljs.core.count(argv) - first_child);
switch (G__56657) {
case (0):
...
var vec__56658 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56658,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56658,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56658,(2),null);
...
var temp__5808__auto___56685 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___56685 == null)){
} else {
var key_56688 = temp__5808__auto___56685;
(jsprops.key = key_56688);
}
...
var temp__5808__auto___56696 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___56696 == null)){
} else {
var key_56697 = temp__5808__auto___56696;
(jsprops.key = key_56697);
}
...
var temp__5808__auto___56708 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___56708 == null)){
} else {
var key_56709 = temp__5808__auto___56708;
(jsprops.key = key_56709);
}
...
var temp__5808__auto___56710 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___56710 == null)){
} else {
var key_56711 = temp__5808__auto___56710;
(jsprops.key = key_56711);
}
...
var temp__5808__auto___56712 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___56712 == null)){
} else {
var key_56713 = temp__5808__auto___56712;
(jsprops.key = key_56713);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56661_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__56661_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__56662 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56662,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56662,(1),null);
...
break;
default:
var G__56721 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__56722 = compiler;
v = G__56721;
compiler = G__56722;
continue;
...
var G__56666 = tag;
var G__56666__$1 = (((G__56666 instanceof cljs.core.Keyword))?G__56666.fqn:null);
switch (G__56666__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template56668 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template56668 = (function (opts,id,fn_to_element,parse_fn,meta56669){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template56668.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_56670,meta56669__$1){
var self__ = this;
var _56670__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template56668(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta56669__$1));
}));

(reagent.impl.template.t_reagent$impl$template56668.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_56670){
var self__ = this;
var _56670__$1 = this;
return self__.meta56669;
}));

(reagent.impl.template.t_reagent$impl$template56668.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template56668.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template56668.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template56668.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template56668.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template56668.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta56669","meta56669",1283602366,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template56668.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template56668.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template56668");

(reagent.impl.template.t_reagent$impl$template56668.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template56668");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template56668.
 */
reagent.impl.template.__GT_t_reagent$impl$template56668 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template56668(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta56669){
return (new reagent.impl.template.t_reagent$impl$template56668(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta56669));
});

}

return (new reagent.impl.template.t_reagent$impl$template56668(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
