...
var len__5769__auto___55865 = arguments.length;
var i__5770__auto___55866 = (0);
while(true){
if((i__5770__auto___55866 < len__5769__auto___55865)){
args__5775__auto__.push((arguments[i__5770__auto___55866]));

var G__55867 = (i__5770__auto___55866 + (1));
i__5770__auto___55866 = G__55867;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq55828){
var G__55829 = cljs.core.first(seq55828);
var seq55828__$1 = cljs.core.next(seq55828);
var G__55830 = cljs.core.first(seq55828__$1);
var seq55828__$2 = cljs.core.next(seq55828__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55829,G__55830,seq55828__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__55836_SHARP_){
return (!((cljs.core.meta(p1__55836_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55848__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e55849){var _e__52758__auto__ = e55849;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e55851){var _e__52758__auto__ = e55851;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__55855 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__55856 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__55856);
...
var map__55857 = opts;
var map__55857__$1 = cljs.core.__destructure_map(map__55857);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55857__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__55855);
}});
...
var temp__5802__auto___55876 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___55876)){
var managed_print_level_55877 = temp__5802__auto___55876;
var _STAR_print_level_STAR__orig_val__55861_55878 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__55862_55879 = managed_print_level_55877;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__55862_55879);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__55860_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__55860_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__55861_55878);
}} else {
job_fn();
}
