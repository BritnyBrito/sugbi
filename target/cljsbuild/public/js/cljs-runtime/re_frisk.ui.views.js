...
});})(i__64367,vec__64369,idx,name,diff,item,c__5521__auto__,size__5522__auto__,b__64368,s__64366__$2,temp__5804__auto__,items))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__64368),re_frisk$ui$views$history_item_$_iter__64365(cljs.core.chunk_rest(s__64366__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__64368),null);
}
} else {
var vec__64372 = cljs.core.first(s__64366__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64372,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64372,(1),null);
var diff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64372,(2),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64372,(3),null);
return cljs.core.cons((cljs.core.truth_(diff)?cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"align","align",1964212802),new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"border-bottom","border-bottom",2110948415),"1px solid #ebebeb"], null),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),new cljs.core.Keyword(null,"pointer","pointer",85071187),new cljs.core.Keyword(null,"width","width",-384071477),"200px",new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"5px",new cljs.core.Keyword(null,"text-overflow","text-overflow",-1022366814),new cljs.core.Keyword(null,"ellipsis","ellipsis",998505738),new cljs.core.Keyword(null,"white-space","white-space",-707351930),new cljs.core.Keyword(null,"nowrap","nowrap",457264988),new cljs.core.Keyword(null,"overflow","overflow",2058931880),new cljs.core.Keyword(null,"hidden","hidden",-312506092),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"purple","purple",-876021126)], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__64372,idx,name,diff,item,s__64366__$2,temp__5804__auto__,items){
return (function (event){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(tool_state,cljs.core.assoc,new cljs.core.Keyword(null,"selected-event","selected-event",898030638),item);
...
return event.preventDefault();
});})(vec__64372,idx,name,diff,item,s__64366__$2,temp__5804__auto__,items))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.gap,new cljs.core.Keyword(null,"size","size",1098693007),"10px"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.frisk.Root_Simple,diff], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)):null),re_frisk$ui$views$history_item_$_iter__64365(cljs.core.rest(s__64366__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.components.scroller,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"#f3f3f3"], null)], null),(function (){var iter__5523__auto__ = (function re_frisk$ui$views$app_db_view_$_iter__64375(s__64376){
return (new cljs.core.LazySeq(null,(function (){
var s__64376__$1 = s__64376;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__64376__$1);
if(temp__5804__auto__){
var s__64376__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__64376__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__64376__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__64378 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__64377 = (0);
while(true){
if((i__64377 < size__5522__auto__)){
var watcher = cljs.core._nth(c__5521__auto__,i__64377);
cljs.core.chunk_append(b__64378,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.views.watch_item,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(app_db_derefed,watcher),watcher,watchers], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),watcher], null)));

var G__64395 = (i__64377 + (1));
i__64377 = G__64395;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__64378),re_frisk$ui$views$app_db_view_$_iter__64375(cljs.core.chunk_rest(s__64376__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__64378),null);
}
} else {
var watcher = cljs.core.first(s__64376__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.views.watch_item,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(app_db_derefed,watcher),watcher,watchers], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),watcher], null)),re_frisk$ui$views$app_db_view_$_iter__64375(cljs.core.rest(s__64376__$2)));
}
} else {
return null;
}
...
var map__64379 = cljs.core.deref(tool_state);
var map__64379__$1 = cljs.core.__destructure_map(map__64379);
var timeline_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64379__$1,new cljs.core.Keyword(null,"timeline-opened?","timeline-opened?",1560712236));
var paused_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64379__$1,new cljs.core.Keyword(null,"paused?","paused?",-135058553));
var graph_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64379__$1,new cljs.core.Keyword(null,"graph-opened?","graph-opened?",153449318));
var stat_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64379__$1,new cljs.core.Keyword(null,"stat-opened?","stat-opened?",1063397443));
var views_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64379__$1,new cljs.core.Keyword(null,"views-opened?","views-opened?",-1040443216));
var events_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64379__$1,new cljs.core.Keyword(null,"events-opened?","events-opened?",-1069565502));
...
var len__5769__auto___64402 = arguments.length;
var i__5770__auto___64403 = (0);
while(true){
if((i__5770__auto___64403 < len__5769__auto___64402)){
args__5775__auto__.push((arguments[i__5770__auto___64403]));

var G__64404 = (i__5770__auto___64403 + (1));
i__5770__auto___64403 = G__64404;
continue;
} else {
}
break;
...
(re_frisk.ui.views.main_view.cljs$core$IFn$_invoke$arity$variadic = (function (re_frame_data,tool_state,p__64383){
var vec__64384 = p__64383;
var doc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64384,(0),null);
...
/** @this {Function} */
(re_frisk.ui.views.main_view.cljs$lang$applyTo = (function (seq64380){
var G__64381 = cljs.core.first(seq64380);
var seq64380__$1 = cljs.core.next(seq64380);
var G__64382 = cljs.core.first(seq64380__$1);
var seq64380__$2 = cljs.core.next(seq64380__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64381,G__64382,seq64380__$2);
}));
