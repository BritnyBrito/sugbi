...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_62909 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_62909(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_62938 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_62938(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62941 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_62941(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62943 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_62943(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62946 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_62946(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62949 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_62949(reader);
}
});
...
var G__62986 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__62987 = s.append(c);
c = G__62986;
s = G__62987;
continue;
}
