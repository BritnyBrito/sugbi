...
var trimmed = (function (){var G__68965 = text;
if((G__68965 == null)){
return null;
} else {
return clojure.string.trim(G__68965);
}
})();
...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__68966){
var map__68967 = p__68966;
var map__68967__$1 = cljs.core.__destructure_map(map__68967);
var state = map__68967__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68967__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68967__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__69097 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__69098 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__69097;
remaining = G__69098;
continue;
} else {
var G__69099 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__69100 = cljs.core.rest(remaining);
buf = G__69099;
remaining = G__69100;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__68968){
var map__68969 = p__68968;
var map__68969__$1 = cljs.core.__destructure_map(map__68969);
var state = map__68969__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68969__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68969__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68969__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68969__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68969__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__68974){
var map__68975 = p__68974;
var map__68975__$1 = cljs.core.__destructure_map(map__68975);
var state = map__68975__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68975__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68975__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__68982){
var map__68983 = p__68982;
var map__68983__$1 = cljs.core.__destructure_map(map__68983);
var state = map__68983__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68983__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__68980_SHARP_){
var vec__68984 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__68980_SHARP_,(1),(cljs.core.count(p1__68980_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68984,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68984,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68988)].join('');
} else {
return G__68988;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__68987_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__68987_SHARP_,(1),(cljs.core.count(p1__68987_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__68991){
var map__68992 = p__68991;
var map__68992__$1 = cljs.core.__destructure_map(map__68992);
var state = map__68992__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68992__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__68993){
var map__68994 = p__68993;
var map__68994__$1 = cljs.core.__destructure_map(map__68994);
var state = map__68994__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68994__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__68997){
var map__68998 = p__68997;
var map__68998__$1 = cljs.core.__destructure_map(map__68998);
var state = map__68998__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68998__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68998__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__5043__auto__ = paragraph;
if(cljs.core.truth_(and__5043__auto__)){
var G__68999 = next_line;
var G__68999__$1 = (((G__68999 == null))?null:clojure.string.trim(G__68999));
if((G__68999__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__68999__$1,"```");
}
} else {
return and__5043__auto__;
}
...
markdown.transformers.code = (function markdown$transformers$code(text,p__69000){
var map__69001 = p__69000;
var map__69001__$1 = cljs.core.__destructure_map(map__69001);
var state = map__69001__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var indent_code_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69001__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
...
if(cljs.core.truth_(code)){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [[markdown.common.escape_code(clojure.string.replace_first(text,/    /,"\n")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__69002 = state;
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__69002,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__69002;
}
})()], null);
...
if((num_spaces >= (4))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["<pre><code>",markdown.common.escape_code(clojure.string.replace_first(text,/    /,"")),(cljs.core.truth_(should_close_QMARK_)?"</code></pre>":null)].join(''),(function (){var G__69003 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"code","code",1586293142),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"indented-code","indented-code",-904930175),true], 0));
if(cljs.core.truth_(should_close_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__69003,new cljs.core.Keyword(null,"indent-code-end","indent-code-end",644690061),true);
} else {
return G__69003;
}
})()], null);
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__69006){
var map__69007 = p__69006;
var map__69007__$1 = cljs.core.__destructure_map(map__69007);
var state = map__69007__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69007__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69007__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69007__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69007__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69007__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = (function (){var G__69011 = next_line;
var G__69011__$1 = (((G__69011 == null))?null:clojure.string.trim(G__69011));
if((G__69011__$1 == null)){
return null;
} else {
return clojure.string.ends_with_QMARK_(G__69011__$1,"```");
}
})();
...
var vec__69012 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69012,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69012,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__69018){
var map__69019 = p__69018;
var map__69019__$1 = cljs.core.__destructure_map(map__69019);
var state = map__69019__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69019__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69019__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69019__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__5045__auto__ = code;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__69025){
var map__69026 = p__69025;
var map__69026__$1 = cljs.core.__destructure_map(map__69026);
var state = map__69026__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69026__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69026__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69026__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69026__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return (function (p1__69027_SHARP_){
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__69027_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__69028){
var vec__69029 = p__69028;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69029,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69029,(1),null);
...
var vec__69035 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69035,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69035,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69035,(2),null);
var vec__69038 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69038,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69038,(1),null);
...
var vec__69052 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69052,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69052,(1),null);
...
var G__69214 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__69215 = cljs.core.rest(remain);
var G__69216 = key;
acc = G__69214;
remain = G__69215;
prev_key = G__69216;
