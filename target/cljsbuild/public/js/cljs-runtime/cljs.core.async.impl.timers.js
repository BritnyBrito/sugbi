...
var i_61395 = (0);
while(true){
if((i_61395 < arr.length)){
(arr[i_61395] = null);

var G__61396 = (i_61395 + (1));
i_61395 = G__61396;
continue;
} else {
}
...
var i_61413 = (self__.level + (1));
while(true){
if((i_61413 <= (new_level + (1)))){
(update[i_61413] = self__.header);

var G__61414 = (i_61413 + (1));
i_61413 = G__61414;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_61415 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_61415[i]));
} else {
x__$2.forward.push((((i < links_61415.length))?(links_61415[i]):null));
}

if((i < links_61415.length)){
(links_61415[i] = x__$2);
} else {
links_61415.push(x__$2);
}
...
var i_61421 = (0);
while(true){
if((i_61421 <= self__.level)){
var links_61422 = (update[i_61421]).forward;
if((x__$1 === (((i_61421 < links_61422.length))?(links_61422[i_61421]):null))){
(links_61422[i_61421] = (x__$1.forward[i_61421]));

var G__61423 = (i_61421 + (1));
i_61421 = G__61423;
continue;
} else {
var G__61424 = (i_61421 + (1));
i_61421 = G__61424;
continue;
}
} else {
...
var G__61429 = nx;
var G__61430 = (level__$1 - (1));
x = G__61429;
level__$1 = G__61430;
continue;
} else {
var G__61431 = x;
var G__61432 = (level__$1 - (1));
x = G__61431;
level__$1 = G__61432;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__61435 = nx;
var G__61436 = (level__$1 - (1));
x = G__61435;
level__$1 = G__61436;
continue;
} else {
var G__61437 = x;
var G__61438 = (level__$1 - (1));
x = G__61437;
level__$1 = G__61438;
continue;
}
