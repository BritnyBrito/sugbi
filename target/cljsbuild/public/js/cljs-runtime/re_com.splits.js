...
var len__5769__auto___61896 = arguments.length;
var i__5770__auto___61897 = (0);
while(true){
if((i__5770__auto___61897 < len__5769__auto___61896)){
args__5775__auto__.push((arguments[i__5770__auto___61897]));

var G__61898 = (i__5770__auto___61897 + (1));
i__5770__auto___61897 = G__61898;
continue;
} else {
}
break;
...
(re_com.splits.h_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__61750){
var map__61751 = p__61750;
var map__61751__$1 = cljs.core.__destructure_map(map__61751);
var args = map__61751__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61751__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61751__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61751__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61751__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61751__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61751__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61751__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
...
var G__61760_61902 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__61760_61902) : on_split_change.call(null,G__61760_61902));
} else {
}
...
var _LT_html_GT__QMARK_ = (function (p1__61744_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__61744_SHARP_,document.documentElement);
});
...
return (function() { 
var G__61908__delegate = function (p__61815){
var map__61816 = p__61815;
var map__61816__$1 = cljs.core.__destructure_map(map__61816);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61816__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__61908 = function (var_args){
var p__61815 = null;
if (arguments.length > 0) {
var G__61932__i = 0, G__61932__a = new Array(arguments.length -  0);
while (G__61932__i < G__61932__a.length) {G__61932__a[G__61932__i] = arguments[G__61932__i + 0]; ++G__61932__i;}
  p__61815 = new cljs.core.IndexedSeq(G__61932__a,0,null);
} 
return G__61908__delegate.call(this,p__61815);};
G__61908.cljs$lang$maxFixedArity = 0;
G__61908.cljs$lang$applyTo = (function (arglist__61933){
var p__61815 = cljs.core.seq(arglist__61933);
return G__61908__delegate(p__61815);
});
G__61908.cljs$core$IFn$_invoke$arity$variadic = G__61908__delegate;
return G__61908;
})()
;
}));
...
/** @this {Function} */
(re_com.splits.h_split.cljs$lang$applyTo = (function (seq61748){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61748));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___61934 = arguments.length;
var i__5770__auto___61936 = (0);
while(true){
if((i__5770__auto___61936 < len__5769__auto___61934)){
args__5775__auto__.push((arguments[i__5770__auto___61936]));

var G__61937 = (i__5770__auto___61936 + (1));
i__5770__auto___61936 = G__61937;
continue;
} else {
}
break;
...
(re_com.splits.v_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__61832){
var map__61834 = p__61832;
var map__61834__$1 = cljs.core.__destructure_map(map__61834);
var args = map__61834__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61834__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61834__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61834__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61834__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61834__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61834__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__61834__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
...
var stop_drag = (function (){
if(cljs.core.truth_(on_split_change)){
var G__61840_61938 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__61840_61938) : on_split_change.call(null,G__61840_61938));
} else {
}
...
var _LT_html_GT__QMARK_ = (function (p1__61822_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__61822_SHARP_,document.documentElement);
});
var mouseout = (function (event){
if(_LT_html_GT__QMARK_(event.relatedTarget)){
return stop_drag();
...
return (function() { 
var G__61956__delegate = function (p__61852){
var map__61853 = p__61852;
var map__61853__$1 = cljs.core.__destructure_map(map__61853);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61853__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var G__61956 = function (var_args){
var p__61852 = null;
if (arguments.length > 0) {
var G__61969__i = 0, G__61969__a = new Array(arguments.length -  0);
while (G__61969__i < G__61969__a.length) {G__61969__a[G__61969__i] = arguments[G__61969__i + 0]; ++G__61969__i;}
  p__61852 = new cljs.core.IndexedSeq(G__61969__a,0,null);
} 
return G__61956__delegate.call(this,p__61852);};
G__61956.cljs$lang$maxFixedArity = 0;
G__61956.cljs$lang$applyTo = (function (arglist__61970){
var p__61852 = cljs.core.seq(arglist__61970);
return G__61956__delegate(p__61852);
});
...
/** @this {Function} */
(re_com.splits.v_split.cljs$lang$applyTo = (function (seq61826){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq61826));
}));
