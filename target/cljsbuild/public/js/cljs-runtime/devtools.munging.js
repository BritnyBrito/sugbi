...
var o55194 = temp__5802__auto__;
var temp__5802__auto____$1 = (o55194["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o55195 = temp__5802__auto____$1;
return (o55195["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__52746__auto__ = f;
return (o__52746__auto__["toString"]).call(o__52746__auto__);
} else {
return "";
}
}catch (e55203){var _ = e55203;
return "";
}});
...
try{var o__52746__auto___55544 = t;
(o__52746__auto___55544["cljs$lang$ctorPrWriter"]).call(o__52746__auto___55544,t,writer);
}catch (e55258){var __55545 = e55258;
}
...
var char_code = (function (){var o__52746__auto__ = (new String(char$));
return (o__52746__auto__["charCodeAt"]).call(o__52746__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__52746__auto__ = String;
return (o__52746__auto__["fromCharCode"]).call(o__52746__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__55278 = num_code;
switch (G__55278) {
case (1):
return (185);
...
var o__52746__auto__ = String;
return (o__52746__auto__["fromCharCode"]).call(o__52746__auto__,superscript_code);
});
/**
...
}catch (e55295){var _e__52758__auto__ = e55295;
return false;
}})())){
...
var vec__55296 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55296,(0),null);
...
var len__5769__auto___55548 = arguments.length;
var i__5770__auto___55549 = (0);
while(true){
if((i__5770__auto___55549 < len__5769__auto___55548)){
args__5775__auto__.push((arguments[i__5770__auto___55549]));

var G__55551 = (i__5770__auto___55549 + (1));
i__5770__auto___55549 = G__55551;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__55324){
var vec__55325 = p__55324;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55325,(0),null);
...
var G__55554 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__55555 = cljs.core.butlast(remaining_tokens);
name_tokens = G__55554;
remaining_tokens = G__55555;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq55318){
var G__55319 = cljs.core.first(seq55318);
var seq55318__$1 = cljs.core.next(seq55318);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55319,seq55318__$1);
}));
...
var vec__55334 = cljs.core.split_with((function (p1__55332_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__55332_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55334,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55334,(1),null);
...
var vec__55343 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55343,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55343,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__55559 = cljs.core.rest(remaining_tokens);
var G__55560 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__55559;
name_tokens = G__55560;
continue;
} else {
...
var vec__55354 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55354,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55354,(1),null);
var vec__55357 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55357,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55357,(1),null);
var vec__55360 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55360,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55360,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55360,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55360,(3),null);
...
var vec__55368 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55368,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55368,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55368,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55368,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55368,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55368,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__55371 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55371,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55371,(1),null);
var vec__55374 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55374,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55374,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__55377 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__55377) : devtools.munging.parse_fn_info_deep.call(null,G__55377));
})()));
}
} else {
return fn_info;
...
var G__55577 = (arity + (1));
var G__55578 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__55392){
var vec__55393 = p__55392;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55393,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55393,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55412_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__55412_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55413_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__55413_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__55416){
var vec__55417 = p__55416;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55417,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq55414){
var G__55415 = cljs.core.first(seq55414);
var seq55414__$1 = cljs.core.next(seq55414);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55415,seq55414__$1);
}));
...
var map__55473 = options;
var map__55473__$1 = cljs.core.__destructure_map(map__55473);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55473__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55473__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55473__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55473__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__55474 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55474,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55474,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55474,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55474,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55474,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55474,(5),null);
...
var o__52746__auto__ = f;
return (o__52746__auto__["getBasis"]).call(o__52746__auto__);
});
/**
...
}catch (e55491){var _e__52758__auto__ = e55491;
...
var G__55585 = (obj[cljs.core.first(path)]);
var G__55586 = cljs.core.rest(path);
obj = G__55585;
path = G__55586;
continue;
} else {
...
var _STAR_ = (function (accum,p__55518){
var vec__55519 = p__55518;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55519,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55519,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__55522){
var vec__55523 = p__55522;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55523,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55523,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55523,(2),null);
...
var post_process = (function (p__55527){
var vec__55528 = p__55527;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55528,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55528,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55526_SHARP_){
return (obj[cljs.core.first(p1__55526_SHARP_)]);
}),sorted_matches);
