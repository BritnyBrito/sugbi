...
var len__5769__auto___68617 = arguments.length;
var i__5770__auto___68618 = (0);
while(true){
if((i__5770__auto___68618 < len__5769__auto___68617)){
args__5775__auto__.push((arguments[i__5770__auto___68618]));

var G__68619 = (i__5770__auto___68618 + (1));
i__5770__auto___68618 = G__68619;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq68593){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq68593));
}));
...
var G__68624 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5802__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__68594_SHARP_,p1__68594_SHARP_);
});})(text,state,matches,temp__5802__auto__))
);
});})(text,state,matches,temp__5802__auto__))
,text,matches);
var G__68625 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5802__auto__){
return (function (p1__68595_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__68595_SHARP_,matches);
});})(text,state,matches,temp__5802__auto__))
);
text = G__68624;
state = G__68625;
...
var vec__68607 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__68610 = (function (){var G__68613 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__68614 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__68613,G__68614) : transformer.call(null,G__68613,G__68614));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68610,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68610,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68607,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68607,(1),null);
var G__68637 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__68638 = cljs.core.PersistentVector.EMPTY;
var G__68639 = cljs.core.rest(tokens);
var G__68640 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__68637;
buf = G__68638;
tokens = G__68639;
cur_state = G__68640;
...
var G__68641 = out;
var G__68642 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__68643 = cljs.core.rest(tokens);
var G__68644 = cur_state;
out = G__68641;
buf = G__68642;
tokens = G__68643;
cur_state = G__68644;
...
var G__68657 = out;
var G__68658 = buf;
var G__68659 = cljs.core.rest(tokens);
var G__68660 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__68657;
buf = G__68658;
tokens = G__68659;
cur_state = G__68660;
...
var G__68661 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__68662 = buf;
var G__68663 = cljs.core.rest(tokens);
var G__68664 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__68661;
buf = G__68662;
tokens = G__68663;
cur_state = G__68664;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__68615_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__68615_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__68616_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__68616_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__68616_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
